...
export class MonolithBondV2__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MonolithBondV2__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MonolithBondV2__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MonolithBondV2 extends ethereum.SmartContract {
  static bind(address: Address): MonolithBondV2 {
    return new MonolithBondV2("MonolithBondV2", address);
  }
  ...
  adjustment(): MonolithBondV2__adjustmentResult {
    ...
    return new MonolithBondV2__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<MonolithBondV2__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new MonolithBondV2__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): MonolithBondV2__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new MonolithBondV2__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<MonolithBondV2__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MonolithBondV2__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  terms(): MonolithBondV2__termsResult {
    let result = super.call(
      "terms",
    ...
    return new MonolithBondV2__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<MonolithBondV2__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MonolithBondV2__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
...
export class UpdateFeedCall extends ethereum.Call {
  get inputs(): UpdateFeedCall__Inputs {
    return new UpdateFeedCall__Inputs(this);
  }

  get outputs(): UpdateFeedCall__Outputs {
    return new UpdateFeedCall__Outputs(this);
  }
}

export class UpdateFeedCall__Inputs {
  _call: UpdateFeedCall;

  constructor(call: UpdateFeedCall) {
    this._call = call;
  }
...
export class UpdateFeedCall__Outputs {
  _call: UpdateFeedCall;
