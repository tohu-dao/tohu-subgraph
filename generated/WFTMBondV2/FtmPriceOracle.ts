...
export class FtmPriceOracle__getRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FtmPriceOracle__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FtmPriceOracle__proposedGetRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FtmPriceOracle__proposedLatestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FtmPriceOracle extends ethereum.SmartContract {
  static bind(address: Address): FtmPriceOracle {
    return new FtmPriceOracle("FtmPriceOracle", address);
  }
  ...
  getRoundData(_roundId: BigInt): FtmPriceOracle__getRoundDataResult {
    let result = super.call(
      "getRoundData",
    ...
    return new FtmPriceOracle__getRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<FtmPriceOracle__getRoundDataResult> {
    let result = super.tryCall(
      "getRoundData",
      "getRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    ...
    return ethereum.CallResult.fromValue(
      new FtmPriceOracle__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestRoundData(): FtmPriceOracle__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
    ...
    return new FtmPriceOracle__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(): ethereum.CallResult<
    FtmPriceOracle__latestRoundDataResult
  > {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FtmPriceOracle__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedGetRoundData(
    _roundId: BigInt
  ): FtmPriceOracle__proposedGetRoundDataResult {
    let result = super.call(
      "proposedGetRoundData",
    ...
    return new FtmPriceOracle__proposedGetRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedGetRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<FtmPriceOracle__proposedGetRoundDataResult> {
    let result = super.tryCall(
      "proposedGetRoundData",
      "proposedGetRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FtmPriceOracle__proposedGetRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedLatestRoundData(): FtmPriceOracle__proposedLatestRoundDataResult {
    let result = super.call(
    ...
    return new FtmPriceOracle__proposedLatestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedLatestRoundData(): ethereum.CallResult<
    FtmPriceOracle__proposedLatestRoundDataResult
  > {
    let result = super.tryCall(
      "proposedLatestRoundData",
      "proposedLatestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FtmPriceOracle__proposedLatestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
