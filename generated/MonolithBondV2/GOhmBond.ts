...
export class GOhmBond__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GOhmBond__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GOhmBond__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GOhmBond extends ethereum.SmartContract {
  static bind(address: Address): GOhmBond {
    return new GOhmBond("GOhmBond", address);
  }
  ...
  adjustment(): GOhmBond__adjustmentResult {
    ...
    return new GOhmBond__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<GOhmBond__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new GOhmBond__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): GOhmBond__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new GOhmBond__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(param0: Address): ethereum.CallResult<GOhmBond__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  terms(): GOhmBond__termsResult {
    ...
    return new GOhmBond__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<GOhmBond__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256)",
      []
