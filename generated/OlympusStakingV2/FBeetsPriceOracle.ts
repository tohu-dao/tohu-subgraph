...
export class FBeetsPriceOracle__getRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FBeetsPriceOracle__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FBeetsPriceOracle extends ethereum.SmartContract {
  static bind(address: Address): FBeetsPriceOracle {
    return new FBeetsPriceOracle("FBeetsPriceOracle", address);
  }
  ...
  getRoundData(_roundId: BigInt): FBeetsPriceOracle__getRoundDataResult {
    ...
    return new FBeetsPriceOracle__getRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<FBeetsPriceOracle__getRoundDataResult> {
    ...
    return ethereum.CallResult.fromValue(
      new FBeetsPriceOracle__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestRoundData(): FBeetsPriceOracle__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
    ...
    return new FBeetsPriceOracle__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(): ethereum.CallResult<
    FBeetsPriceOracle__latestRoundDataResult
  > {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FBeetsPriceOracle__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
...
export class ConstructorCall__Inputs {
  ...
  get _vestingToken(): Address {
    return this._call.inputValues[0].value.toAddress();
  }

  get _ftmUsdOracle(): Address {
    return this._call.inputValues[1].value.toAddress();
  }

  get _fBeetsBar(): Address {
