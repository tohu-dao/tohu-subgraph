...
import { GOHMBOND_TOKEN } from './utils/Constants'
import { loadOrCreateToken } from './utils/Tokens'
import { createDailyBondRecord } from './utils/DailyBond'
import { getGOhmUSDRate } from './utils/Price'
...
export function handleDeposit(call: DepositCall): void {
  ...
  let token = loadOrCreateToken(GOHMBOND_TOKEN)
  ...
  deposit.value = amount.times(getGOhmUSDRate())
...
export function handleRedeem(call: RedeemCall): void {
  ...
  redemption.token = loadOrCreateToken(GOHMBOND_TOKEN).id;
